...
function M.mappings(client, bufnr)
  ...
  vim.keymap.set('n', '<leader>gv', buf_def_vsplit, opts)
  vim.keymap.set('n', '<c-]>', buf_def, opts)
  vim.keymap.set('n', '<leader>dp', diag_prev, diag_prev_opts)
  vim.keymap.set('n', '<leader>df', diag_open_float, diag_open_float_opts)
  vim.keymap.set('n', '<leader>ds', diag_show, diag_show_opts)
  vim.keymap.set('n', '<leader>dn', diag_next, diag_next_opts)
